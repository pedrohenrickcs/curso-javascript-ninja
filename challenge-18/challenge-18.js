(function () {
    ...
    */
    ...
    cpfs.map(function (items) {
      console.log(cleanCPF(items).replace(/(\d\d\d)(\d\d\d)(\d\d\d)(\d\d)/g, '$1.$2.$3-$4'));
    });
    ...
    */
    ...
    var rgx = /ju[nl]ho/g;
    var word = 'Os meses de janeiro, junho e julho começam com a letra j.';

    console.log(word.match(rgx));
    ...
    */
    ...
    var tagHtml = '<div><section><blockquote>Texto <img /></blockquote></section></div>';
    var rgxHtml = /\<\w+\>/g;

    console.log(tagHtml.match(rgxHtml));
    ...
    */
    ...
    var tagHtmlClose = '<div><ul><li></li><li></li><li><span></span></li></ul></div>';
    var rgxHtmlClose = /\<\w+\>\<\/\w+\>/g;

    console.log(tagHtmlClose.match(rgxHtmlClose));
